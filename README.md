...
### 2. **Analyze your data!**
From here, click on the Looker Studio link in your Terraform outputs to start analyzing the image and text data! Gemini will analyze the landmark images and prewritten text prompts when you invoke the stored procedures.
